...
python ../../veil_switch.pyc ../topologies/fat-tree-k2.adlist ../topologies/fat-tree-k2.vid localhost:4003 20 &
...
python ../../veil_switch.pyc ../topologies/fat-tree-k2.adlist ../topologies/fat-tree-k2.vid localhost:2005 0 &
